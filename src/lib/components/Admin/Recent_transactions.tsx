...
// Import the new RecentTransactionsTable component
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-white">1,235</p>
                  <span className="text-green-400 text-sm flex items-center">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <span className="text-red-400 text-sm flex items-center">
                    <ArrowDownRight className="w-4 h-4 mr-1" /> +15.8%
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-gray-400 text-sm">Security Alerts</h3>
                  <p className="text-2xl font-semibold text-white">3</p>
                  <span className="text-red-400 text-sm flex items-center">
                    <ArrowUpRight className="w-4 h-4 mr-1" /> Critical
                  </span>
                </div>
              </div>
            </div>
